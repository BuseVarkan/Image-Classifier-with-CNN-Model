...
#
# PROGRAMMER: Buse Varkan
# DATE CREATED: 7 August 2022
# REVISED DATE:
...
def calculates_results_stats(results_dic):
    ...
    for values in results_dic.values():
        ...
        if (values[2] == 1) and (values[3] == 1) and (values[4] == 1):
    ...
    if results_stats_dic['n_correct_breed'] > 0:
